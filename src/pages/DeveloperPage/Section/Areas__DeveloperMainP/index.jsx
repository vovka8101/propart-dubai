...
import "./areas__DeveloperMainP.scss";
...
const index = () => {
  ...
  const shuffledData = shuffleArray(areaData);

  return (
    <section className="areasDevP">
      <h2 className="areasDevP__title">
        {t("developerMainPage__AboutAreasDevelopersTitle")}
      </h2>
      <div className="areasWithMapPage__topProjects">
        {shuffledData.slice(0, 8).map((item, index) => (
          <div
