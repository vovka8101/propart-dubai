...
export const developersData = [
  ...
  },
  {
    ...
    about_the_company: [
      "Developer Tebyan Properties has completed several projects in the United Arab Emirates over the years, including hotels, office centers and residential complexes. Sparkle Towers consists of three high-rise residential buildings which were built in partnership with Swarovski and are located in Dubai Marina district. A distinctive feature is the exterior lighting, consisting of almost 2,000 lamps. The complex includes studios, apartments with one, two and three bedrooms, as well as penthouses with four bedrooms. Within walking distance from the complex there are local attractions, beaches, shopping centers, the Dubai Marina and the Dubai Marina Walk. Public transport system is well developed, it is only 20 minutes to Downtown Dubai and 30 minutes to DXB airport. The price for residential real estate starts at USD 302,000 (AED 1,109,306). *The price is valid for 2021. With a modern approach, the high competence of their specialists, and the use of innovative technologies in architecture and construction, private developer Tebyan Properties successfully implements grandiose projects to build technically complex facilities.",
    ],
    gallery_images: [
  ...
  },
  {
    ...
    about_the_company: [
      "Redwood Avenue Villas consists of 47 luxury villas, each with 5-6 bedrooms. The community offers outdoor recreation – the parks, beautifully landscaped alleys and nature reserves within Redwood are ideal for this purpose. Each site is designed by experienced architects. Redwood Avenue offers individual landscapes for each villa: natural stone compositions imitating mountain slopes, mosaics and water elements. Buyers can not only choose from 11 architectural styles and several interior schemes, but also design their own home.",
    ],
    gallery_images: [
  ...
  },
  {
    ...
    about_the_company: [
      "One of Innovate Living’s popular properties is Palme Couture. It includes 14 luxury residences with fully furnished apartments. Each residence has a spacious living room and stylish dining room, a convenient storage room and a fully equipped modern kitchen. All residences are equipped with smart home systems and are fully serviced by a concierge. Palme Couture residents can use the swimming pool, access the spa, beauty salon, massage room and local gym, and relax in the cigar lounge and barbecue area. Moreover, each apartment is assigned a parking space in the underground parking lot. Apartments in the innovative Palme Couture start from AED 21,000,000 (USD 5,800,000). The price depends on the characteristics of the living space. Palme Couture Residences is a good option for those who want to make Dubai their permanent place of residence. Buying a property here can be done under a special payment plan: housing can be purchased in installments, making small cash payments gradually. Palme Couture is also suitable for those who want to invest their capital wisely. The popularity of real estate in Dubai is constantly growing, which means that the purchase of apartments from the developer Innovate Living is a good investment with a high return. *The price is valid for 2020",
    ],
    gallery_images: [
  ...
  },
  {
    ...
    about_the_company: [
      "The construction company has two residential complexes. Construction work is still going on in their area of operation. This residential complex is located in the prestigious Meydan-City district. You are offered a 1-4 bedroom apartments with a size ranging from 800 to 2000 sq.m. Royal Pearls is set up like a small family town. There is a theater, fitness center, supermarket, spa and beauty salons, and playgrounds for children. The starting price for luxury housing is about USD 300,000 or AED 1,169,824. *The price is valid for 2023. The concept for these residences is to combine the classic with the modern in the interior. Multifunctional apartments have from 1 to 4 bedrooms and smart home technology for the comfort and safety of the residents. The district where this complex is located, Nad Al Sheba, has a good reputation. Within walking distance of the residential complex is Meydan Racecourse, the Falcon Museum of History, tennis courts, nightclubs and the Deep Dive Dubai sports complex, where you can safely dive. Tonino Lamborghini Residences also has parks, restaurants, stores, fitness facilities and a swimming pool, educational institutions and clinics. To live in these high-tech apartments, you should be prepared to pay from USD 383,000, that is about AED 1,500,000. *The price is valid for 2023",
    ],
    gallery_images: [],
    section_5_info: [
      {
  ...
  },
  {
    ...
    about_the_company: [
      "The developer’s biggest achievement was the Falconcity City of Wonders project in DubaiLand, Dubai’s largest district. On the site of the community, which resembles a falcon’s figure, there are life-size copies of the wonders of ancient and modern history: the Eiffel Tower, the pyramids of Egypt, the Hanging Gardens of Semiramis, the Alexandria Lighthouse, the Leaning Tower of Pisa, the Taj Mahal, the Great Wall of China and others. Falconcity City real estate is represented by exclusive villas and apartments for residential complexes and hotels, surrounded by infrastructure facilities. The uniqueness of the project is to combine tourists’ desire to relax on the beach and at the same time admire the wonders of the world, collected in one place. In SAAM Vega, a pyramid-shaped development, studios are priced from AED 570,000 (USD 155,000) and are sized from 36 sq.m. (388 sq ft). One-bedroom apartments cost from AED 1,082,000 (USD 294,500) and offer a living space of 51 sq.m. (549 sq ft). Three-bedroom villas in Western Residence North are selling from AED 2,800,000 (USD 762,000) with 374 sq m (4026 sq ft). A 4-bedroom, 477 sqm (5134 sqf) villa is also available for AED 3,800,000 (USD 1,034,000) and a 5-bedroom 446 sqm (4801 sqf) residence is available for AED 2,541,000 (USD 692,000). Off-plan 5-bedroom villas at Eastern Residence, depending on their size, range from AED 2,540,000 (USD 691,500) to AED 5,500,000 (USD 1,500,000). *The price is valid for 2023",
    ],
    gallery_images: [],
    section_5_info: [
      {
...
export const shortDevelopersData = [
  {
    title: "Emaar",
    value: "emaar",
    logo_src:
  ...
  { title: "Gemini", value: "gemini", logo_src: null },
  { title: "SOL Properties", value: "sol-properties", logo_src: null },
  { title: "Al Futtaim Group", value: "al-futtaim-group", logo_src: null },
  { title: "Oriental Pearls", value: "oriental-pearls", logo_src: null },
  { title: "Muraba Properties", value: "muraba-properties", logo_src: null },
  { title: "Green Group", value: "green-group", logo_src: null },
  { title: "Accor", value: "accor", logo_src: null },
  {
    title: "Falconcity of Wonders",
    value: "falconcity-of-wonders",
    logo_src: null,
  },
  { title: "Royal Group", value: "royal-group", logo_src: null },
];
